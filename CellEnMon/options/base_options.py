...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ngf', type=int, default=3, help='# of gen filters in the last conv layer')
        parser.add_argument('--ndf', type=int, default=3, help='# of discrim filters in the first conv layer')
