...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ngf', type=int, default=124, help='# of gen filters in the last conv layer')
        parser.add_argument('--ndf', type=int, default=slice_dist, help='# of discrim filters in the first conv layer')
        parser.add_argument('--netD', type=str, default='pixel',
                            help='specify discriminator architecture [n_layers | pixel]. n_layers allows you to specify the layers in the discriminator')
