...
import torch
import CellEnMon.models as models
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='CellEnMon_CycleGan', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--netD', type=str, default='n_layers', help='specify discriminator architecture [n_layers]. n_layers allows you to specify the layers in the discriminator')
