...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--slice_dist', type=int, default=1024, #do not change
        ...
        parser.add_argument('--ndf', type=int, default=1024, help='# of discrim filters in the first conv layer')
