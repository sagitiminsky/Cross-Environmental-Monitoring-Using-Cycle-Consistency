...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--n_epochs_decay', type=int, default=3000, help='number of epochs to linearly decay learning rate to zero')
        parser.add_argument('--beta1', type=float, default=0.1, help='momentum term of adam')
        parser.add_argument('--lr', type=float, default=0.0000003, help='initial learning rate for adam') # 0.00001
        ...
        parser.add_argument('--lr_decay_iters', type=int, default=100000, help='multiply by a gamma every lr_decay_iters iterations')
